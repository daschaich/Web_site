...
\begin{spacelist}
  ...
  1455 citations; \ \ \href{https://en.wikipedia.org/wiki/H-index}{$h = 23$}; \ \ \href{https://en.wikipedia.org/wiki/G-index}{$g = 36$} \\[2 pt]
...
%\vspace{20 pt} {\large \bfseries In active preparation} \hfill(ordered by anticipated completion)
  \pagebreakitem
    \optem{Thermal phase structure of the BMN matrix model from the lattice} \\
    Simon Catterall, Raghav G.~Jha, Anosh Joseph, David Schaich and Toby Wiseman \\
  \pagebreakitem
    \optem{Gravitational waves from stealth dark matter} \\
