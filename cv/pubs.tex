...
\begin{spacelist}
  ...
  1621 citations; \ \ \href{https://en.wikipedia.org/wiki/H-index}{$h = 24$}; \ \ \href{https://en.wikipedia.org/wiki/G-index}{$g = 39$} \\[2 pt]
...
\vspace{20 pt} {\large \bfseries In active preparation} \hfill(ordered by anticipated completion)
  \pagebreakitem
    \optem{Thermal phase structure of the plane-wave matrix model from the lattice} \\
    Simon Catterall, Raghav G.~Jha, Anosh Joseph, David Schaich and Toby Wiseman \\
  \pagebreakitem
    \optem{Stealth dark matter at finite temperature and gravitational waves} \\
    LSD Collaboration: Thomas Appelquist, Richard C.~Brower, George T.~Fleming, Xiao-Yong Jin \textit{et al.} \\ % TODO: full author list... [Cushman?]
  \pagebreakitem
    \optem{Thermodynamics of (2+1)-dimensional maximally supersymmetric Yang--Mills theory} \\
