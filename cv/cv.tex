...
\begin{document}
\raggedright
\makeheading{David Schaich --- Curriculum vitae \hfill \textnormal{\footnotesize{25 April 2020}}}
% ------------------------------------------------------------------
...
\vspace{-12 pt} % Get things to line up
60 publications; \ 1621 citations; \ \href{https://en.wikipedia.org/wiki/H-index}{$h = 24$}; \ \href{https://en.wikipedia.org/wiki/G-index}{$g = 39$} \\[1 pt]
...
\vspace{-12 pt} % Get things to line up
\begin{tabular}[t]{cl}
  2020 & \href{http://www.usqcd.org}{USQCD} proposal under review requesting 12M core hours                   \\ % BNL (KNL)
       & \textit{Composite Higgs model with four light and six heavy flavors}                                 \\[6 pt]
  2020 & USQCD proposal under review requesting 2.14M core hours                                              \\ % Fermilab
       & \textit{Decoupling doublers using generalized Yukawa interactions}                                   \\[6 pt]
  2020 & ALCC proposal under review requesting 999k node hours                                                \\ % Cori at Berkeley
       & \textit{Exploring dynamics beyond the Standard Model}                                                \\[6 pt]
...
%       &  Exascale Computing Algorithms and Infrastructures Benefitting UK Research (ExCALIBUR) programme     \\
  ...
  2020 & UoL Research Centre in Mathematics and Modelling workshop grant, 3000 GBP                            \\
       & \textit{Physics of strongly interacting fermions in low-dimensional materials}                       \\
       & \hspace{1 cm} \textit{and high-energy physics: a numerical perspective} (cancelled due to pandemic)  \\[6 pt]
  2019 & USQCD computing allocation, 10M core hours                                                           \\ % BNL (KNL)
       & \textit{Composite Higgs model with four light and six heavy flavors}                                 \\[6 pt]
  2019 & UK Research \& Innovation Future Leader Fellowship {MR/S015418/1}, 943k GBP                          \\
       & \textit{New Frontiers of Lattice Field Theory}                                                       \\
\end{tabular}
...
\begin{tabular}[t]{cl}
  ...
  2016--2019    & Nouman Butt (advisor: Simon Catterall), Syracuse University                                 \\
                ...
                & \qquad \lra Postdoc (Argonne Nnational Lab)                                                 \\[6 pt]
...
\begin{tabular}[t]{cl}
  ...
  2020 & Physics of strongly interacting fermions in low-dimensional materials \\
       ...
       & University of Liverpool, 18 March (cancelled due to COVID-19 pandemic)      \\[6 pt]
...
\begin{tightlist}
  ...
  \item Independent Progress Assessment Panel member for two PhD students, 2019 \\
\end{tightlist}
...
% ------------------------------------------------------------------
\newpage
%\makeheading{Publications \hfill \textnormal{{\footnotesize (1621 citations; \ \href{https://en.wikipedia.org/wiki/H-index}{$h = 24$}; \ \href{https://en.wikipedia.org/wiki/G-index}{$g = 39$}; \ \href{http://inspirehep.net/author/profile/D.Schaich.1}{inspirehep.net/author/profile/D.Schaich.1})}}}
