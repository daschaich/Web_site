...
\begin{document}
\raggedright
\makeheading{David Schaich --- Curriculum vitae \hfill \textnormal{\footnotesize{22 September 2023}}}
% ------------------------------------------------------------------
...
\vspace{-12 pt} % Get things to line up
81 publications; \ 2316 citations; \ \href{https://en.wikipedia.org/wiki/H-index}{$h = 27$}; \ \href{https://en.wikipedia.org/wiki/G-index}{$g = 46$} \\[1 pt]
...
%             & \qquad \lra \TODO{...} industry (Redrow)                         \\
...
%             & \qquad \lra Manufacturing industry (Carpenter Additive)                         \\
\end{tabular}
