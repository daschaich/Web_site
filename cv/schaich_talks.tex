...
\usepackage[paper=letterpaper,
            ...
            marginparsep=0.15 in,  % Space between titles and text
            margin=0.75 in,
            includemp]{geometry}
...
\lfoot{\hspace{\footpageshift}%
       \parbox{4in}{\, \hfill %
       Presentations page \arabic{page} of \protect\pageref*{LastPage} % +LP
%       \arabic{page}                 % -LP
       \hfill \,}}
...
\begin{document}
\raggedright
\makeheading{David Schaich --- Presentations \hfill \textnormal{\footnotesize{21 June 2018}}}
\input{talks}
\end{document}
% ------------------------------------------------------------------
